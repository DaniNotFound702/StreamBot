    ...
    async execute(context) {
        ...
        if (!audioIndex) {
            ...
            if (currentAudio !== undefined) {
                const current = mediaInfo.AudioStreams.find((audio) => audio.Index === currentAudio) || mediaInfo.AudioStreams[currentAudio];
            ...
            const audioStreamIndex = selected.Index ?? idx;
            ...
            logger.info(`User ${userId} selected audio track ${audioStreamIndex} (${language}) for ${currentItem.title}`);
