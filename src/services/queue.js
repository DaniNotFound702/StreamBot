...
export class QueueService {
    ...
    async addToQueue(mediaSource, requestedBy, originalInput) {
        return this.add(mediaSource.url, mediaSource.title, requestedBy, mediaSource.type, mediaSource.isLive, originalInput || mediaSource.url, mediaSource.sourceId);
    }
    async add(url, title, requestedBy, type = 'url', isLive = false, originalInput, sourceId) {
        const queueItem = {
            id: this.generateId(),
            url,
            title,
