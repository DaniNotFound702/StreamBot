...
export declare class StreamingService {
    ...
    private pausedTimeMs;
    private isPaused;
    private currentCommand;
    private isSwitchingTracks;
    ...
    pauseCurrent(message: Message): Promise<void>;
    resumeCurrent(message: Message): Promise<void>;
    switchTracksDynamic(message: Message): Promise<void>;
    ...
    playVideo(message: Message, videoSource: string, title?: string, videoParams?: {
        ...
        fps?: number;
        bitrate?: number;
    }, seekTimeMs?: number, trackOverrides?: any): Promise<void>;
